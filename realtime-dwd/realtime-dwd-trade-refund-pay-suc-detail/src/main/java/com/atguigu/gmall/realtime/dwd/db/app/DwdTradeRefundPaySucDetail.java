...
public class DwdTradeRefundPaySucDetail extends BaseSQLApp {
    ...
    public void handle(StreamExecutionEnvironment env, StreamTableEnvironment tableEnv) {
        ...
        readDB(tableEnv,Constant.TOPIC_DWD_TRADE_REFUND_PAYMENT_SUCCESS);
        ...
        tableEnv.executeSql("create table "+Constant.TOPIC_DWD_TRADE_REFUND_PAYMENT_SUCCESS+"(" +
                ...
                ")" + SQLUtil.getUpsertKafkaDDL(Constant.TOPIC_DWD_TRADE_REFUND_PAYMENT_SUCCESS,Constant.KAFKA_BROKERS));
